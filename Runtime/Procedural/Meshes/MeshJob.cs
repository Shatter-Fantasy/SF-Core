...
// Helps burst compile use the correct generic job data.
[assembly:RegisterGenericJobType(typeof(MeshJob<PlaneMesh,MultiMeshStream>))]
[assembly:RegisterGenericJobType(typeof(MeshJob<PlaneMesh,SingleMeshStream>))]
...
namespace SF.Procedural
{
        ...
        where TStream: struct, IMeshStreams
    {
            ...
            )
        {
            ...
            // Schedule the jobs to run parallel than return the job handles created for the jobs.
