    ...
    public struct SharedTriangleGrid : IMeshGenerator
    {
        ...
        public void Execute<S>(int z, S streams) where S : struct, IMeshStreams
        {
            ...
            */
            ...
            // The offset goes between positive and negative each row of quads.
            float xOffset = -0.25f;
            float uOffset = 0f;
            ...
            // Helps center around the origin of the ripple
            ...
            // (0, 1) Stretch out the textcoordinate over the whole mesh.
            ...
            for(int x = 1; x <= Resolution; x++, vertexIndex++, triangleIndex += 2)
            {
                ...
                /* Traingle Equilateral Formula
                   Height of an equilateral traingle to (sqrt of 3) / 2 it's edge length.
                   We multiply the z coordinates by this formula.
                 */
